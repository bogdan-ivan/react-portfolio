...
const Modal = () => {
  ...
  const addImageToPost = (e) => {
    ...
    // Once browser is ready reading the file
              ...
              bg-red-100 cursor-pointer"
                ...
                <div>
                  <div className="mt-3 text-center sm:mt-5">
                    <Dialog.Title
                      as="h3"
                      className="text-lg leading-6 font-medium Otext-gray-900"
                    >
                      Upload a photo
                    </Dialog.Title>
                ...
                <div className="mt-5 sm:mt-6">
                 ...
                 text-white hover:bg-red-700 focus:outline-none focus:ring-1 
                 focus:ring-offset-2 focus:ring-red-500 sm:text-sm disabled:cursor-not-allowed 
                 hover:disabled:bg-gray-308 ${!!selectedFile && 'bg-blue-600 hover:bg-blue-700'}`}
                 onClick={uploadPost}
